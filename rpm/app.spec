%define name pasang-binatang.ign
%define release 1
%define version 0.1
%define license MIT
...
install -d -m 755 $RPM_BUILD_ROOT/opt/ignsdk/%{name}/game/images
install -d -m 755 $RPM_BUILD_ROOT/opt/ignsdk/%{name}/bin
install -d -m 755 $RPM_BUILD_ROOT/opt/ignsdk/%{name}/game
...
cp -rf game/images/* $RPM_BUILD_ROOT/opt/ignsdk/%{name}/game/images
cp -rf game/* $RPM_BUILD_ROOT/opt/ignsdk/%{name}/game
%clean
